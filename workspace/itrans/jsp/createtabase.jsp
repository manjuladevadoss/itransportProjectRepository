...
li{
	...
	padding-left:5px;
	color: #ffffff;
	font: 8px/8px Roboto, Helvetica, sans-serif;
}		
#items :hover{
	/*color: green; */
	background:orange;
 	 ...
 	 <!-- Right click  menu -->		
		...
		<!-- End of Right click  menu -->
				...
				<tr><td>
				 ...
				 <table width="98%" id="dataTAtbl">
					<tr>
						<th width="10%"> <a href="#" ng-click="sortTypenv = 'startime'; sortReversenv = !sortReversenv"><font  size="2px" style="color:#ffffff">Status</font></a></th>
						<th width="13%"> <a href="#" ng-click="sortTypenv = 'endtime'; sortReversenv = !sortReversenv"><font  size="2px" style="color:#ffffff">Time</font></a></th>
						<th width="16%"> <a href="#" ng-click="sortTypenv = 'alarmid'; sortReversenv = !sortReversenv"><font  size="2px" style="color:#ffffff">Alert ID</font></a></th>
						<th width="14%"> <a href="#" ng-click="sortTypenv = 'desc'; sortReversenv = !sortReversenv"><font  size="2px" style="color:#ffffff">Road Name</font></a></th>
						<th width="17%"> <a href="#" ng-click="sortTypenv = 'status'; sortReversenv = !sortReversenv"><font  size="2px" style="color:#ffffff">Description</font></a></th>
						<th width="10%"> <a href="#" ng-click="sortTypenv = 'status'; sortReversenv = !sortReversenv"><font  size="2px" style="color:#ffffff">Source</font></a></th>
					</tr>
				</table> 
			</td></tr>
			<tr><td>			
