...
/* Start to draw circle and line */
    ...
    new Color([237,28,36]), 3),new Color([81,91,117,0.25])
        ...
        function initToolbar() {
          ...
          on(dom.byId("infovideodiv"), "click", function(evt) {
              if ( evt.target.id === "infovideodiv" ) {
                return;
              }
            });          
        }
...
// ********** start timeslider and infowindow ********* //
     ...
     //   timeExtent.endTime = new Date("12/31/2020 UTC");
       ...
       timeExtent.endTime = new Date("05/16/2019 20:00:00 UTC"); 
     ...
     function infowindowmsg(evt) {
         ...
         if(endValString==startValString) {
             ...
             map.infoWindow.setContent(
                 "TIP 675231 <br> Road Closed at Marina Ctr To Shenton Way - Use Nth Bridge Rd or Victoria St"
             );
             ...
             //map.infoWindow.setTitle("Coordinates");
             map.infoWindow.setContent(
             "TIP 568231 <br> Massive Jam Around Marian Center"
             );
             var pt = new Point(latitude, longitude);
             map.infoWindow.show(pt, map.getInfoWindowAnchor(evt.screenPoint));
             ...
             //map.infoWindow.setTitle("Coordinates");
             map.infoWindow.setContent(
             "TIP 825231 <br> Expect Delays near Marina Ctr To Shenton Way" 
             );
             var pt = new Point(latitude, longitude);
             map.infoWindow.show(pt, map.getInfoWindowAnchor(evt.screenPoint));
            ...
            // map.infoWindow.setTitle("Coordinates");
             map.infoWindow.setContent(
             "TIP 635231 <br> Hello 4 Ophir Road, Singapore" 
             );
             var pt = new Point(latitude, longitude);
             map.infoWindow.show(pt, map.getInfoWindowAnchor(evt.screenPoint));
         }
...
//var pause = 0; //Traffic Video pause variable    
