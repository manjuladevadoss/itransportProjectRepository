				...
				<td align='right'>
			   	 ...
			   	 <td> 	
			   		<div class="dropdown" style="float:right;">
							...
							<a href="ccgridview.jsp"  style="text-decoration: none" ng-click="viewworkorderitem2()">Work Order</a>
							<a href="ccgridview.jsp" style="text-decoration: none" ng-click="viewtecitem2()">Technical Alarms</a>
							<a href="ccgridview.jsp"  style="text-decoration: none" ng-click="viewenvirontem2()">Environment</a>
							<a href="ccgridview.jsp"  style="text-decoration: none"  ng-click="vieweventitem2()">Events</a>
							<a href="ccgridview.jsp"  style="text-decoration: none">Road Works</a>
							 	 <img src="horibar1.JPG" style="padding:5px; height:18px;" >
							<a href="ccgridview.jsp"  style="text-decoration: none">Split Panels</a>
							  </div>
						</div> 
				</td> 
			 </tr>
		...
		<div class="item4">
				 ...
				 <td> 	
				   		<div class="dropdown" style="float:right;">
							...
							<div class="dropdown-content" style="float:left;">
								...
								<a href="envmonTbl.jsp"  style="text-decoration: none">Road Works</a>
								 	 <img src="horibar1.JPG" style="padding:5px; height:18px;" >
								<a href="ccgrid.jsp"  style="text-decoration: none">Split Panels</a>
							</div>
						</div> 
					</td>
				 </tr>
		   ...
		   <br>
			<table width="100%">  <tr><td>
				 <table width="98%" id="datatbl">
					<tr>
						<th width="18%"> <a href="#" ng-click="sortTypenv = 'startime'; sortReversenv = !sortReversenv"><font style="font-size:16px;color:#C8CFF4"> Start Time <i class="fa fa-caret-down" style="font-size:18px;color:#C8CFF4"></i></font></a></th>
						<th width="18%"> <a href="#" ng-click="sortTypenv = 'endtime'; sortReversenv = !sortReversenv"><font style="font-size:16px;color:#C8CFF4"> End Time<i class="fa fa-caret-down" style="font-size:18px;color:#C8CFF4"></i> </font></a></th>
				...
				<div class='scrollwc'>
					<table  id="inctbl" width="100%">
						<tr ng-repeat="envmoni in environmonitorec | orderBy:sortTypenv:sortReversenv | filter:searchEnvifromgrid">
							<td width="18%"><font color="#C8CFF4" size="2px">{{envmoni.startime}}</font></td>
							<td width="18%"><font color="#C8CFF4" size="2px">{{envmoni.endtime}}</font></td>
							<td width="12%"><font color="#C8CFF4" size="2px">{{envmoni.alarmid}}</font></td>
