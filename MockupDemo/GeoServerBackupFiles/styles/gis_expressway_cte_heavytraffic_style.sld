<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
       <se:Rule>
          <se:Name>cte heavy traffic red</se:Name>
          <se:Description>
            <se:Title>cte heavy traffic red</se:Title>
          </se:Description>
         ...
         <se:Rule>
          <se:Name>cte heavy traffic orange</se:Name>
          <se:Description>
            <se:Title>cte heavy traffic orange</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">       
            <ogc:And>  
           	 <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          <se:Name>cte heavy traffic green</se:Name>
          <se:Description>
            <se:Title>cte heavy traffic green</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">       
            <ogc:And>  
           	 <ogc:PropertyIsEqualTo>
