				...
				<div class="dropdown" style="float:right;">
					...
					<div class="dropdown-content" style="float:left;">
					   ...
					   <div ng-hide="showevent">
						   <a href="#"  style="text-decoration: none" ng-click="vieweventitem2()">Incident Record</a>
					   </div>
					...
					<table style="text-align: center;" width="100%" >
							<tr> 
							   <td align="center"> <h10> {{noofeventToday}} </h10> <br><h12>Events(s) Today </h12> </td>
								<td align="center"> <h10> {{noofeventUpcome+1}} </h10> <br> <h12> &nbsp;&nbsp; &nbsp;&nbsp;  Upcoming Event </h12> </td>
							 </tr>
						 </table>
						 <br>
					...
					<tr><td>
						...
						<table width="100%"> 
								<tr><td style="text-align: right;">
										<a href="createventbase.jsp" target="_self" style="text-decoration:none;"> <h11> New Event </h11></a>
								</td></tr>
