			...
			<td> 	
			   		<div class="dropdown" style="float:right;">
							 ...
							 <div class="dropdown-content" style="float:left;">
								...
								<div ng-hide="showenv">
									<a href="#"  style="text-decoration: none" ng-click="viewenvirontem2()">Traffic Alerts</a>
								</div>	 
			 ...
			 <div ng-show="showinc">
					<table width="80%" >
							<tr> 
								<td align="center"> <h10> 2 </h10> <br><h12> In progress</h12> </td>
								<td align="center"> <h10> 2 </h10> <br> <h12>  Notified </h12> </td>
								<td align="center"> <h10> 1 </h10> <br> <h12>  Confirmed </h12> </td>
							</tr>
						</table>
<br>
				<table width="100%"> 
					...
					<tr><td>  
			<div class='scrollinc'>
					<!-- 	<div ng-show='accTrafficAlertStatus1'>
							<table>
								<tr>
			...
			<div ng-show="showenv">
				<!-- <div ng-show="showevent"> -->
				 <table width="100%" >
						 <tr> 
							 <td align="center"> <h10> 1 </h10> <br><h12> Unverified</h12> </td>
							 <td align="center"> <h10> 6 </h10> <br> <h12>  Verified </h12> </td>
										...
										<tr>
												<td width="10%">
													...
													<div ng-if="accTrafficAlertStatus=='True'" > 
														<font color="#ffffff" size="2px">{{accTrafficAlertStatus}}</font>
													</div>
													<div ng-if="accTrafficAlertStatus!='True'" > 
														<a href="#"  ng_click="trafficalertwindow()" style="text-decoration:none;"> <font color="red" size="2px">{{accTrafficAlertStatus}}</font> </a>  
													</div>
												...
												<td width="13%">
													...
													<div ng-if="accTrafficAlertStatus!='True'" > 
														<a href="#"  ng_click="trafficalertwindow()" style="text-decoration:none;"> <font color="red" size="2px">{{accTrafficAlertTime}}</font> </a>  
													</div>
												</td>
												<td width="16%">
													<div ng-if="accTrafficAlertStatus=='True'" > 
														<font color="#ffffff" size="2px">{{accTrafficAlertid}}</font>
													</div>
													<div ng-if="accTrafficAlertStatus!='True'" > 
														<a href="#"  ng_click="trafficalertwindow()" style="text-decoration:none;"> <font color="red" size="2px">{{accTrafficAlertid}}</font> </a>  
													</div>											
												 </td>
												<td width="14%">
													<div ng-if="accTrafficAlertStatus=='True'" > 
												...
												<td width="18%">
													<div ng-if="accTrafficAlertStatus=='True'" > 
														<font color="#ffffff" size="2px">{{accTrafficAlertDesc}}</font>
													</div>
													<div ng-if="accTrafficAlertStatus!='True'" > 
														<a href="#"  ng_click="trafficalertwindow()" style="text-decoration:none;"> <font color="red" size="2px">{{accTrafficAlertDesc}}</font> </a>  
													</div>											
												</td>
												<td width="12%">
													<div ng-if="accTrafficAlertStatus=='True'" > 
														<font color="#ffffff" size="2px">{{accTrafficAlertSource}}</font>
													</div>
													<div ng-if="accTrafficAlertStatus!='True'" > 
														<a href="#"  ng_click="trafficalertwindow()" style="text-decoration:none;"> <font color="red" size="2px">{{accTrafficAlertSource}}</font> </a>  
													</div>												
												</td>
										</tr>
		...
		<table width="100%">  <tr><td>
				 <table width="98%" id="datatbl">
					<tr>
						...
						<th width="20%"> <a href="#" ng-click="sortTypeta = 'alarmid'; sortReverseta = !sortReverseta"  style="text-decoration:none;"> <font style="font-size:16px;color:#ffffff">Alarm ID</font></a></th>
			 ...
			 <td> 	
			   		<div class="dropdown" style="float:right;">
							...
							<div class="dropdown-content" style="float:left;">
								...
								<a href="#" style="text-decoration: none">Traffic Alerts</a>
							 </div>
				  </div> 
			</td>
		...
		<table width="100%">  <tr><td>
				 <table width="98%" id="datatbl">
					<tr>
						...
						<th width="12%"> <a href="#" ng-click="sortTypeta = 'status'; sortReverseta = !sortReverseta"  style="text-decoration:none;"> <font style="font-size:16px;color:#ffffff">Status</font></a></th>
						<!-- <th width="11%"> <a href="#" ng-click="sortTypeta = 'zone'; sortReverseta = !sortReverseta"  style="text-decoration:none;"> <font style="font-size:16px;color:#ffffff">Zone</font></a></th>  -->
					</tr>
				</table> 
			</td></tr>
			...
			<table width="100%">
				 ...
				 <td> 	
			   		<div class="dropdown" style="float:right;">
							...
							<img src="listimg.png" style="width:13px; height:13px;">
							<div class="dropdown-content" style="float:left;">
								<a href="#" style="text-decoration: none">Incident Records</a>
								<a href="#" style="text-decoration: none">Work Orders</a>
								<a href="#" style="text-decoration: none">Events</a>
								<a href="#" style="text-decoration: none">Technical Alarms</a>
							 </div>
				  </div> 
