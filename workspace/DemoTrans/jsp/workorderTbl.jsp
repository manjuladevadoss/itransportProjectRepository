	   ...
	   <td>
		...
		<tr>
			...
			<tr ng-repeat="workOrder in workorderRec | orderBy:sortType:sortReverse | filter:searchWorkOrder">
				<td bgcolor="#43498F"><p>{{workOrder.date}}</p></td>
				<td bgcolor="#43498F"><p>{{workOrder.wonum}}</p></td>
				<td bgcolor="#43498F"><p>{{workOrder.descri}}</p></td>
				<td bgcolor="#43498F"><p>{{workOrder.status}}</p></td>
				<td bgcolor="#43498F"><p>{{workOrder.zone}}</p></td>
			</tr>
	</table>     
    </div>
